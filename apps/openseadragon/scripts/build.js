...
const constants = {
  ...
  CONTENT_SCRIPT_ENTRIES: ["boot-loader.ts", "osd-monkey-patch.ts", "output-thread.ts"], // relative to src
...
async function pack() {
  ...
  const outFilename = `openseadragon-spacemouse-${version}.chrome.zip`;
